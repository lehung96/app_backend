            ...
            <tr>
                <td style="padding: 10px 0 30px 0;">
                    <table id="order-total" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr width="100%">
                            <td style="text-align: center;font-weight: bold;font-size: 20px;color: #ec1f26;">Bạn vừa được tạo thành công tài khoản DSA!</td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td id="body-text" style="text-align: left;font-size: 19px; font-weight: 400; color: #2E2E2E;">
                                Xin chào, <br />
                                Bạn vừa được tạo thành công tài khoản DSA để đăng nhập app Easy Credit. <br />
                                Tài khoản: <span style="color: rgb(13, 146, 194); "> ${username} </span><br />
                                Mật khẩu: <span style="color: #ec1f26;"> ${password} </span><br />
                                Nếu bạn đã đăng nhập và đổi mật khẩu hãy bỏ qua email này!
                            </td>
                        </tr>
                    </table>
                </td>
